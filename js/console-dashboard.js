...
(function () {
  ...
  function render() {
    ...
    $("cd-runs-sub").textContent = n === 1 ? "this session" : "this session";
  ...
  function renderTable() {
    ...
    var rows = runs.slice().reverse().map(function (r) {
      ...
      var label = r.score != null ? "Passed" : "Recorded";
  ...
  var newRun = $("cd-new-run");
  if (newRun) newRun.onclick = function () {
    var ws = document.querySelector(".cd-workspace-head");
