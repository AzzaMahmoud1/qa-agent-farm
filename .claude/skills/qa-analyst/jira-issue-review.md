...
This skill is **in addition to** `.claude/skills/qa-analyst/SKILL.md` (requirements breakdown). Do not replace that path. Use this file when the task is: fetch the story, review it (with attachments), and post Testing Team feedback to Jira.
...
3. Review the Jira issue with attachments and get the review feedback using `.claude/skills/qa-analyst/jira-requirements-review.md` (or the corresponding review tool).
