...
When spawning or instructing worker agents, they MUST run on **Claude Sonnet** (`claude-sonnet-5`). Do not run worker analysis on Fable 5.
...
Follow `.claude/skills/qa-orchestrator/SKILL.md` and `agents/orchestrator.js`.
