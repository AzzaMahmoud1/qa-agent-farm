...
function validateAnalystOutput(story, analystOutput) {
  ...
  // MAIN GATE (prompt readiness contract) — keep in sync with agents/analyst-contract.js
  const ruleMainGate = "MAIN GATE: Analyst owns readiness via orchestrator_actions";
