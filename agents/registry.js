...
const AGENT_GUIDELINES = {
      ...
      writer: {
        level: "L3",
        required_deliverables: ["test_cases", "given_when_then", "ac_mapping", "evidence_citation", "ac_verdicts"],
        rules: [
          ...
          "Emit ac_verdicts: every Analyst testable_condition is written OR skip_reason — no silent drops",
          "Skip ACs listed in analyst unimplemented_rules with skip_reason",
          "On integrity failure: one corrective retry with failure context, then stop",
...
export {
  ...
  PIPELINE_GATE_FAILURE_STREAK_MAX,
